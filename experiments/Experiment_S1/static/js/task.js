...
// specify the actual conditions we want to run; psiTurk's random condition numbers only go from 0 to num_conds
// var conditionsToRun = [2, 5];
// var mycondition = conditionsToRun[condition];
var mycondition = 5; // hardcode the condition because we want to bypass psiTurk's flawed counterbalancing mechanism
...
var memoryQuestionnaire = function() {
	...
	function textSubmitted() {
		...
		if (!raiseError) {
			...
			if (phase > nPhases) {
				...
				questionID = questionList[phase-1][curTrial-1];
				// $('#' + questionID).css('display', 'inline-block');
				$('#' + questionID).show();
			}
  ...
  ***************************/
  ...
  psiTurk.showPage('memory_experiment.html');
	...
	var htmlByCondition = {
													...
													2:{
													 ...
													 3:{
														 'promptA1':'Consider the events of your life.<br><br>Can you think of any <em>specific, memorable event </em> that happened?<br><br>Try to place yourself back in that situation. Make your memory as specific as possible.<br><br>Once you have your memory in mind, click below to continue.<br>',
														 'promptB1':'Think about the memory you just described.<br><br>Can you think of any other <em>specific</em> event from your life that is <em>very similar</em> to the one you just described?<br><br>Take a moment to think of this other memory.<br><br>Click to continue once you have your second memory in mind.<br>',
														 'relateAB':'Let\'s call the first memory you described "<span style="color: green">Memory A</span>". We\'ll refer to the second memory you described as "<span style="color: blue">Memory B</span>". What makes <span style="color: green">Memory A</span> and <span style="color: blue">Memory B</span> similar to one another?',
														 'additionalTextAB':'Is there anything else we may not have asked about that you\'d like to share regarding the similarities between the two memories? Feel free to speculate.'
														 },
													 ...
													 6:{
														 'promptA1':'Consider the time between 10am and noon yesterday.<br><br>Can you think of a <em>specific event</em> that happened in that time?<br><br>Try to place yourself back in that situation. Make your memory as specific as possible.<br><br>Once you have your memory in mind, click below to continue.<br>',
														 'promptB1':'Think about the memory you just described.<br><br>Can you think of any other <em>specific</em> event from your life that is <em>very similar</em> to the one you just described?<br><br>Take a moment to think of this other memory.<br><br>Click to continue once you have your second memory in mind.<br>',
														 'relateAB':'Let\'s call the first memory you described "<span style="color: green">Memory A</span>". We\'ll refer to the second memory you described as "<span style="color: blue">Memory B</span>". What makes <span style="color: green">Memory A</span> and <span style="color: blue">Memory B</span> similar to one another?',
														 'additionalTextAB':'Is there anything else we may not have asked about that you\'d like to share regarding the similarities between the two memories? Feel free to speculate.'
														 },
													 ...
													 9:{
														 'promptA1':'Consider the time between noon and 2pm yesterday.<br><br>Can you think of a <em>specific event</em> that happened in that time?<br><br>Try to place yourself back in that situation. Make your memory as specific as possible.<br><br>Once you have your memory in mind, click below to continue.<br>',
														 'promptB1':'Think about the memory you just described.<br><br>Can you think of any other <em>specific</em> event from your life that is <em>very similar</em> to the one you just described?<br><br>Take a moment to think of this other memory.<br><br>Click to continue once you have your second memory in mind.<br>',
														 'relateAB':'Let\'s call the first memory you described "<span style="color: green">Memory A</span>". We\'ll refer to the second memory you described as "<span style="color: blue">Memory B</span>". What makes <span style="color: green">Memory A</span> and <span style="color: blue">Memory B</span> similar to one another?',
														 'additionalTextAB':'Is there anything else we may not have asked about that you\'d like to share regarding the similarities between the two memories? Feel free to speculate.'
														 },
													 ...
													 12:{
															'promptA1':'Consider the time between 2pm and 4pm yesterday.<br><br>Can you think of a <em>specific event</em> that happened in that time?<br><br>Try to place yourself back in that situation. Make your memory as specific as possible.<br><br>Once you have your memory in mind, click below to continue.<br>',
															'promptB1':'Think about the memory you just described.<br><br>Can you think of any other <em>specific</em> event from your life that is <em>very similar</em> to the one you just described?<br><br>Take a moment to think of this other memory.<br><br>Click to continue once you have your second memory in mind.<br>',
															'relateAB':'Let\'s call the first memory you described "<span style="color: green">Memory A</span>". We\'ll refer to the second memory you described as "<span style="color: blue">Memory B</span>". What makes <span style="color: green">Memory A</span> and <span style="color: blue">Memory B</span> similar to one another?',
															'additionalTextAB':'Is there anything else we may not have asked about that you\'d like to share regarding the similarities between the two memories? Feel free to speculate.'
															},
													 ...
													 15:{
															'promptA1':'Consider the time between 4pm and 6pm yesterday.<br><br>Can you think of a <em>specific event</em> that happened in that time?<br><br>Try to place yourself back in that situation. Make your memory as specific as possible.<br><br>Once you have your memory in mind, click below to continue.<br>',
															'promptB1':'Think about the memory you just described.<br><br>Can you think of any other <em>specific</em> event from your life that is <em>very similar</em> to the one you just described?<br><br>Take a moment to think of this other memory.<br><br>Click to continue once you have your second memory in mind.<br>',
															'relateAB':'Let\'s call the first memory you described "<span style="color: green">Memory A</span>". We\'ll refer to the second memory you described as "<span style="color: blue">Memory B</span>". What makes <span style="color: green">Memory A</span> and <span style="color: blue">Memory B</span> similar to one another?',
															'additionalTextAB':'Is there anything else we may not have asked about that you\'d like to share regarding the similarities between the two memories? Feel free to speculate.'
															},
  ...
  /* shuffle catch trial order */
	...
	questionList[5] = questionList[5].slice(0, 7);
	...
	var catchIndex = [15, 30, 45, 60, 75, 90];
