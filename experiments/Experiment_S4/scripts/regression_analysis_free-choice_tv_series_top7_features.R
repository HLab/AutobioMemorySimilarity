...
mydf <- mydf[, c("emotionalSimilarity", "activitySimilarity", "reoccur", "activitySimilarityJaccard", "grotesqueCaption", "sentimentalCaption", "repulsiveCaption")]
X <- as.matrix(mydf)
matcols <- colnames(X)
...
save("features", "perm.imp", "mse", "mse.chance", "mse.chance.train", "mse.chance.val", file = "results/free_choice_tv_series_regression_rf_top7_features.RData", version = 2)
